    ...
    def test_field_state(self):
        ...
        checkers_true = [
            ...
            Checker(
                ...
                y=2,
                checker_type=CheckerType.WHITE,
                possible_moves=[PossibleMove(x=1, y=3)],
            ),
            Checker(
                checker_num=9,
                your_checker=True,
                ...
                y=2,
                checker_type=CheckerType.WHITE,
                possible_moves=[PossibleMove(x=3, y=3), PossibleMove(x=1, y=3)],
            ),
            Checker(
                checker_num=10,
                your_checker=True,
                ...
                y=2,
                checker_type=CheckerType.WHITE,
                possible_moves=[PossibleMove(x=5, y=3), PossibleMove(x=3, y=3)],
            ),
            Checker(
                checker_num=11,
                your_checker=True,
                ...
                y=2,
                checker_type=CheckerType.WHITE,
                possible_moves=[PossibleMove(x=7, y=3), PossibleMove(x=5, y=3)],
            ),
            Checker(
                checker_num=12,
                your_checker=False,
                ...
                possible_moves=[PossibleMove(x=2, y=4), PossibleMove(x=0, y=4)],
            ),
            Checker(
                checker_num=13,
                your_checker=False,
                ...
                y=5,
                checker_type=CheckerType.BLACK,
                possible_moves=[PossibleMove(x=4, y=4), PossibleMove(x=2, y=4)],
            ),
            Checker(
                checker_num=14,
                your_checker=False,
                ...
                y=5,
                checker_type=CheckerType.BLACK,
                possible_moves=[PossibleMove(x=6, y=4), PossibleMove(x=4, y=4)],
            ),
            Checker(
                checker_num=15,
                your_checker=False,
                ...
                y=5,
                checker_type=CheckerType.BLACK,
                possible_moves=[PossibleMove(x=6, y=4)],
            ),
            Checker(
                checker_num=16,
                your_checker=False,
